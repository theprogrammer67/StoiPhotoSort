...
uses CCR.Exif.Consts, System.AnsiStrings;
...
begin
  ...
  System.AnsiStrings.StrPLCopy(PAnsiChar(Result), S, 4);
end;
...
var
  ...
  Len: Integer;
begin
  Stream.WriteBuffer(System.AnsiStrings.StrPLCopy(Buffer, FSignature, 4)^, 4);
