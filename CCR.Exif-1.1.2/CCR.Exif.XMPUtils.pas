...
uses
  Math, RTLConsts, Contnrs, StrUtils, XSBuiltIns, CCR.Exif.Consts, CCR.Exif.JPEGUtils, System.AnsiStrings; //XSBuiltIns for DateTimeToXMLTime
...
begin
  ...
  try
    ...
    Clear(True);
    if System.AnsiStrings.StrLComp(CharsPtr, PAnsiChar('<?xpacket '), 10) = 0 then
